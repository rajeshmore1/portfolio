                        ...
                        <Cell col={12}>
                            ...
                            <div style={{ textAlign:'center', margin: '2vw' }} data-aos="fade-up"  >
                                <Grid className='shadow-3'>
                                    ...
                                    <Cell col={6}>
                                        <img
                                            src={ProfileImage} alt="RAJESH MORE PROFILE"
                                        />
                                    </Cell>
                                     {/* Description */}
                                    <Cell col={6}>
                                        <p className='about-me' style={{ marginTop: '2em' }}>
                                            Hey Folks!! <br/>I am a Senior Data Scientist at <a className='color' alt='a' href='http://gecbsp.ac.in/'>Data Axle, Pune</a>, India. I am native of Ambajogai, Maharashtra.
                                        </p>
                                        ...
                                        <p className='about-me'>
                                            I believe that the best way to learn something is by sharing what you learned, so, with my friends I have ignited a developer club in my college to make a local programming community and to help each other by sharing knowledge.
                                          </p>
                                        <p className='about-me'>
